...
function listaJugadores($conexion){
	$mconsulta = "SELECT * from jugadores WHERE sexo = 'hombre' AND esSocio = 'si'";
	...
	/////// PRUEBAS //////
		...
		if (file_exists("jugadoresHombresSocios.json")) { unlink ("jugadoresHombresSocios.json"); }

		$mfile = fopen("jugadoresHombresSocios.json", "c+");
		fwrite($mfile, $mjson);
		fclose($mfile);
